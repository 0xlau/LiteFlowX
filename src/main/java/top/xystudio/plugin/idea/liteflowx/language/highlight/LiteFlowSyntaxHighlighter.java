package top.xystudio.plugin.idea.liteflowx.language.highlight;
...
import top.xystudio.plugin.idea.liteflowx.language.LiteFlowLexerAdapter;
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(LiteFlowTypes.LITEFLOW_BREAK)
            ...
            return QLEXPRESS_KEYWORDS_KEYS;
                ...
                || tokenType.equals(LiteFlowTypes.LITEFLOW_MUST)
                ...
                || tokenType.equals(LiteFlowTypes.LITEFLOW_LAND)
                || tokenType.equals(LiteFlowTypes.LITEFLOW_LOR)
                || tokenType.equals(LiteFlowTypes.LITEFLOW_LNOT)
