...
public class LiteFlowAssignExpressImpl extends ASTWrapperPsiElement implements LiteFlowAssignExpress {

  public LiteFlowAssignExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitAssignExpress(this);
  }
