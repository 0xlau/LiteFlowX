...
public class LiteFlowExpressImpl extends ASTWrapperPsiElement implements LiteFlowExpress {

  public LiteFlowExpressImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LiteFlowOpExpress getOpExpress() {
    return findNotNullChildByClass(LiteFlowOpExpress.class);
  }
