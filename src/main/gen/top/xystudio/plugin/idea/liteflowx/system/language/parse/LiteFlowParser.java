...
public class LiteFlowParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // liteFlowConditionExpress | liteFlowNodeRefExpress | liteFlowPlaceHolderRef
  public static boolean liteFlowAllExpress(PsiBuilder b, int l) {
    ...
    if (!r) r = liteFlowPlaceHolderRef(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  // ((liteFlowThenExpress | liteFlowWhenExpress | liteFlowSerExpress | liteFlowParExpress | liteFlowSwitchExpress | liteFlowPreExpress | liteFlowIf2Express | liteFlowIf3Express | liteFlowForExpress | liteFlowIteratorExpress | liteFlowWhileExpress | liteFlowCatchExpress) {DOT (liteFlowIdExpress | liteFlowTagExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress)}*) | liteFlowFinallyExpress
  ...
  // liteFlowThenExpress | liteFlowWhenExpress | liteFlowSerExpress | liteFlowParExpress | liteFlowSwitchExpress | liteFlowPreExpress | liteFlowIf2Express | liteFlowIf3Express | liteFlowForExpress | liteFlowIteratorExpress | liteFlowWhileExpress | liteFlowCatchExpress
  private static boolean liteFlowConditionExpress_1_0_0(PsiBuilder b, int l) {
    ...
    if (!r) r = liteFlowSerExpress(b, l + 1);
    if (!r) r = liteFlowParExpress(b, l + 1);
  ...
  // {DOT (liteFlowIdExpress | liteFlowTagExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress)}*
  ...
  // liteFlowIdExpress | liteFlowTagExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress
  private static boolean liteFlowConditionExpress_1_0_1_0_1(PsiBuilder b, int l) {
    ...
    if (!r) r = liteFlowMaxWaitMilliseconds(b, l + 1);
    if (!r) r = liteFlowRetryExpress(b, l + 1);
    return r;
  }
  ...
  public static boolean liteFlowIf2ElifSubExpress(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, LITEFLOW_LITE_FLOW_IF_2_ELIF_SUB_EXPRESS, r);
    return r;
  }
  ...
  public static boolean liteFlowIf2SubExpress(PsiBuilder b, int l) {
    ...
    exit_section_(b, m, LITEFLOW_LITE_FLOW_IF_2_SUB_EXPRESS, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // maxWaitMilliseconds PAREN_LEFT (number | elVariableRef) PAREN_RIGHT
  public static boolean liteFlowMaxWaitMilliseconds(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowMaxWaitMilliseconds")) return false;
    if (!nextTokenIs(b, LITEFLOW_MAXWAITMILLISECONDS)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, LITEFLOW_LITE_FLOW_MAX_WAIT_MILLISECONDS, null);
    r = consumeTokens(b, 1, LITEFLOW_MAXWAITMILLISECONDS, LITEFLOW_PAREN_LEFT);
    p = r; // pin = 1
    r = r && report_error_(b, liteFlowMaxWaitMilliseconds_2(b, l + 1));
    r = p && consumeToken(b, LITEFLOW_PAREN_RIGHT) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  private static boolean liteFlowMaxWaitMilliseconds_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowMaxWaitMilliseconds_2")) return false;
    boolean r;
    r = consumeToken(b, LITEFLOW_NUMBER);
    if (!r) r = elVariableRef(b, l + 1);
    return r;
  ...
  /* ********************************************************** */
  // liteFlowNodeRef {DOT (liteFlowTagExpress | liteFlowDataExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress)}*
  ...
  // {DOT (liteFlowTagExpress | liteFlowDataExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress)}*
  ...
  // liteFlowTagExpress | liteFlowDataExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress
  ...
  /* ********************************************************** */
  // (node | UNODE) PAREN_LEFT liteFlowNodeStringRef PAREN_RIGHT {DOT (liteFlowTagExpress | liteFlowDataExpress | liteFlowMaxWaitSeconds | liteFlowMaxWaitMilliseconds | liteFlowRetryExpress)}*
  ...
  /* ********************************************************** */
  // PAR PAREN_LEFT liteFlowAllExpress {COMMA liteFlowAllExpress}* PAREN_RIGHT { liteFlowWhenSubExpress }*
  public static boolean liteFlowParExpress(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowParExpress")) return false;
    if (!nextTokenIs(b, LITEFLOW_PAR)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, LITEFLOW_LITE_FLOW_PAR_EXPRESS, null);
    r = consumeTokens(b, 1, LITEFLOW_PAR, LITEFLOW_PAREN_LEFT);
    p = r; // pin = 1
    r = r && report_error_(b, liteFlowAllExpress(b, l + 1));
    r = p && report_error_(b, liteFlowParExpress_3(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, LITEFLOW_PAREN_RIGHT)) && r;
    r = p && liteFlowParExpress_5(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // {COMMA liteFlowAllExpress}*
  private static boolean liteFlowParExpress_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowParExpress_3")) return false;
    while (true) {
      int c = current_position_(b);
      if (!liteFlowParExpress_3_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "liteFlowParExpress_3", c)) break;
    }
    return true;
  }

  // COMMA liteFlowAllExpress
  private static boolean liteFlowParExpress_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowParExpress_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, LITEFLOW_COMMA);
    r = r && liteFlowAllExpress(b, l + 1);
  ...
  private static boolean liteFlowParExpress_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowParExpress_5")) return false;
    while (true) {
      int c = current_position_(b);
      if (!liteFlowParExpress_5_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "liteFlowParExpress_5", c)) break;
    }
    return true;
  }

  // { liteFlowWhenSubExpress }
  private static boolean liteFlowParExpress_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowParExpress_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // BRACE_LEFT BRACE_LEFT (refExpress|number) BRACE_RIGHT BRACE_RIGHT
  public static boolean liteFlowPlaceHolderRef(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowPlaceHolderRef")) return false;
    if (!nextTokenIs(b, LITEFLOW_BRACE_LEFT)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, LITEFLOW_BRACE_LEFT, LITEFLOW_BRACE_LEFT);
    r = r && liteFlowPlaceHolderRef_2(b, l + 1);
    r = r && consumeTokens(b, 0, LITEFLOW_BRACE_RIGHT, LITEFLOW_BRACE_RIGHT);
    exit_section_(b, m, LITEFLOW_LITE_FLOW_PLACE_HOLDER_REF, r);
    return r;
  }

  // refExpress|number
  private static boolean liteFlowPlaceHolderRef_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowPlaceHolderRef_2")) return false;
    boolean r;
    r = refExpress(b, l + 1);
  ...
  public static boolean liteFlowPlaceHolderStatement(PsiBuilder b, int l) {
    ...
    r = liteFlowPlaceholderAssignExpress(b, l + 1);
    p = r; // pin = 1
    r = r && consumeToken(b, LITEFLOW_SEMICOLON);
    exit_section_(b, l, m, r, p, LiteFlowParser::recover_liteFlowStatement);
    return r || p;
  ...
  /* ********************************************************** */
  // liteFlowPlaceHolderRef ASSIGN liteFlowConditionExpress
  public static boolean liteFlowPlaceholderAssignExpress(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowPlaceholderAssignExpress")) return false;
    if (!nextTokenIs(b, LITEFLOW_BRACE_LEFT)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = liteFlowPlaceHolderRef(b, l + 1);
    r = r && consumeToken(b, LITEFLOW_ASSIGN);
    r = r && liteFlowConditionExpress(b, l + 1);
    exit_section_(b, m, LITEFLOW_LITE_FLOW_PLACEHOLDER_ASSIGN_EXPRESS, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // retry PAREN_LEFT number {COMMA string}* PAREN_RIGHT
  public static boolean liteFlowRetryExpress(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowRetryExpress")) return false;
    if (!nextTokenIs(b, LITEFLOW_RETRY)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, LITEFLOW_LITE_FLOW_RETRY_EXPRESS, null);
    r = consumeTokens(b, 1, LITEFLOW_RETRY, LITEFLOW_PAREN_LEFT, LITEFLOW_NUMBER);
    p = r; // pin = 1
    r = r && report_error_(b, liteFlowRetryExpress_3(b, l + 1));
    r = p && consumeToken(b, LITEFLOW_PAREN_RIGHT) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // {COMMA string}*
  private static boolean liteFlowRetryExpress_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowRetryExpress_3")) return false;
    while (true) {
      int c = current_position_(b);
      if (!liteFlowRetryExpress_3_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "liteFlowRetryExpress_3", c)) break;
    }
    return true;
  }

  // COMMA string
  private static boolean liteFlowRetryExpress_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowRetryExpress_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, LITEFLOW_COMMA, LITEFLOW_STRING);
    exit_section_(b, m, null, r);
    return r;
  }

  /* ********************************************************** */
  // SER PAREN_LEFT liteFlowAllExpress {COMMA liteFlowAllExpress}* PAREN_RIGHT
  public static boolean liteFlowSerExpress(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowSerExpress")) return false;
    if (!nextTokenIs(b, LITEFLOW_SER)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, LITEFLOW_LITE_FLOW_SER_EXPRESS, null);
    r = consumeTokens(b, 1, LITEFLOW_SER, LITEFLOW_PAREN_LEFT);
    p = r; // pin = 1
    r = r && report_error_(b, liteFlowAllExpress(b, l + 1));
    r = p && report_error_(b, liteFlowSerExpress_3(b, l + 1)) && r;
    r = p && consumeToken(b, LITEFLOW_PAREN_RIGHT) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // {COMMA liteFlowAllExpress}*
  private static boolean liteFlowSerExpress_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowSerExpress_3")) return false;
    while (true) {
      int c = current_position_(b);
      if (!liteFlowSerExpress_3_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "liteFlowSerExpress_3", c)) break;
    }
    return true;
  }

  // COMMA liteFlowAllExpress
  private static boolean liteFlowSerExpress_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "liteFlowSerExpress_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, LITEFLOW_COMMA);
    r = r && liteFlowAllExpress(b, l + 1);
