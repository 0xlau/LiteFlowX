...
public class LiteFlowLiteFlowAnyExpressImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowAnyExpress {

  public LiteFlowLiteFlowAnyExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowAnyExpress(this);
  }
