...
public class LiteFlowLiteFlowStatementImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowStatement {

  public LiteFlowLiteFlowStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowStatement(this);
  }
