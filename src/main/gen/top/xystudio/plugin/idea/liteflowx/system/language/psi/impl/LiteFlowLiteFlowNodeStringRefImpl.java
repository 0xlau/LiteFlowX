...
public class LiteFlowLiteFlowNodeStringRefImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowNodeStringRef {

  public LiteFlowLiteFlowNodeStringRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowNodeStringRef(this);
  }
