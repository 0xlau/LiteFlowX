...
public class LiteFlowNewExpressImpl extends ASTWrapperPsiElement implements LiteFlowNewExpress {

  public LiteFlowNewExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitNewExpress(this);
  }
