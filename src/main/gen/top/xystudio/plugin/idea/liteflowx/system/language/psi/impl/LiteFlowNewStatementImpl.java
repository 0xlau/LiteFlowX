...
public class LiteFlowNewStatementImpl extends ASTWrapperPsiElement implements LiteFlowNewStatement {

  public LiteFlowNewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public LiteFlowNewExpress getNewExpress() {
    return findNotNullChildByClass(LiteFlowNewExpress.class);
  }
