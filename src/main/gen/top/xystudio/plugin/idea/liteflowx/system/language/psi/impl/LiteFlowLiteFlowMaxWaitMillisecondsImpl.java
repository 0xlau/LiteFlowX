...
public class LiteFlowLiteFlowMaxWaitMillisecondsImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowMaxWaitMilliseconds {

  public LiteFlowLiteFlowMaxWaitMillisecondsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowMaxWaitMilliseconds(this);
  }
