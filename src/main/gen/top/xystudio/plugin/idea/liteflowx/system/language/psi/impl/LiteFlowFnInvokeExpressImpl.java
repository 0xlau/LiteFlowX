...
public class LiteFlowFnInvokeExpressImpl extends ASTWrapperPsiElement implements LiteFlowFnInvokeExpress {

  public LiteFlowFnInvokeExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitFnInvokeExpress(this);
  }
  ...
  @Override
  @NotNull
  public LiteFlowFnParamExpress getFnParamExpress() {
    return findNotNullChildByClass(LiteFlowFnParamExpress.class);
  }

  @Override
  @NotNull
  public LiteFlowRefExpress getRefExpress() {
    return findNotNullChildByClass(LiteFlowRefExpress.class);
  }
