...
public class LiteFlowFnParamExpressImpl extends ASTWrapperPsiElement implements LiteFlowFnParamExpress {

  public LiteFlowFnParamExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitFnParamExpress(this);
  }
