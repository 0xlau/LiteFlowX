...
public class LiteFlowThreeStatementImpl extends ASTWrapperPsiElement implements LiteFlowThreeStatement {

  public LiteFlowThreeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitThreeStatement(this);
  }
  ...
  public LiteFlowThreeExpress getThreeExpress() {
    return findNotNullChildByClass(LiteFlowThreeExpress.class);
  }
