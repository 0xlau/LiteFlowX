...
public class LiteFlowFnInvokeStatementImpl extends ASTWrapperPsiElement implements LiteFlowFnInvokeStatement {

  public LiteFlowFnInvokeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitFnInvokeStatement(this);
  }
  ...
  public LiteFlowFnInvokeExpress getFnInvokeExpress() {
    return findNotNullChildByClass(LiteFlowFnInvokeExpress.class);
  }
