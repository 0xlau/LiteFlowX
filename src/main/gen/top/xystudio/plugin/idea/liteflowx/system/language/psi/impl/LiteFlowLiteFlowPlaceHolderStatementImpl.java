...
public class LiteFlowLiteFlowPlaceHolderStatementImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowPlaceHolderStatement {

  public LiteFlowLiteFlowPlaceHolderStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowPlaceHolderStatement(this);
  }
