...
public class LiteFlowLiteFlowAndExpressImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowAndExpress {

  public LiteFlowLiteFlowAndExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowAndExpress(this);
  }
