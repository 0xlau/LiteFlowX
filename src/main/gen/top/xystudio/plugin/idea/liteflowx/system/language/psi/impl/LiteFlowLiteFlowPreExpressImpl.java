...
public class LiteFlowLiteFlowPreExpressImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowPreExpress {

  public LiteFlowLiteFlowPreExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowPreExpress(this);
  }
