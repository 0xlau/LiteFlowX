...
public class LiteFlowAssignStatementImpl extends ASTWrapperPsiElement implements LiteFlowAssignStatement {

  public LiteFlowAssignStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public LiteFlowAssignExpress getAssignExpress() {
    return findNotNullChildByClass(LiteFlowAssignExpress.class);
  }
