...
public class LiteFlowCodesImpl extends ASTWrapperPsiElement implements LiteFlowCodes {

  public LiteFlowCodesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitCodes(this);
  }
