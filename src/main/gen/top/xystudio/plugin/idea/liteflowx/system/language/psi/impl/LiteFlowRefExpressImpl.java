...
public class LiteFlowRefExpressImpl extends ASTWrapperPsiElement implements LiteFlowRefExpress {

  public LiteFlowRefExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitRefExpress(this);
  }
  ...
  @Override
  @NotNull
  public LiteFlowTypeRef getTypeRef() {
    return findNotNullChildByClass(LiteFlowTypeRef.class);
  }
