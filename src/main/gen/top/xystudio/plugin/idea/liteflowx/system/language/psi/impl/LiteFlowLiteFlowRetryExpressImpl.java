...
public class LiteFlowLiteFlowRetryExpressImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowRetryExpress {

  public LiteFlowLiteFlowRetryExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowRetryExpress(this);
  }
