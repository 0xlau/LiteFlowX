...
public interface LiteFlowTypes {
  ...
  IElementType LITEFLOW_LITE_FLOW_FOR_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_FOR_SUB_EXPRESS");
  ...
  IElementType LITEFLOW_LITE_FLOW_IF_2_ELIF_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_IF_2_ELIF_SUB_EXPRESS");
  IElementType LITEFLOW_LITE_FLOW_IF_2_ELSE_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_IF_2_ELSE_EXPRESS");
  IElementType LITEFLOW_LITE_FLOW_IF_2_ELSE_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_IF_2_ELSE_SUB_EXPRESS");
  IElementType LITEFLOW_LITE_FLOW_IF_2_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_IF_2_EXPRESS");
  IElementType LITEFLOW_LITE_FLOW_IF_2_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_IF_2_SUB_EXPRESS");
  ...
  IElementType LITEFLOW_LITE_FLOW_NODE_STRING_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_NODE_STRING_SUB_EXPRESS");
  ...
  IElementType LITEFLOW_LITE_FLOW_SWITCH_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_SWITCH_SUB_EXPRESS");
  ...
  IElementType LITEFLOW_LITE_FLOW_THEN_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_THEN_SUB_EXPRESS");
  ...
  IElementType LITEFLOW_LITE_FLOW_WHEN_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_WHEN_SUB_EXPRESS");
  IElementType LITEFLOW_LITE_FLOW_WHILE_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_WHILE_EXPRESS");
  IElementType LITEFLOW_LITE_FLOW_WHILE_SUB_EXPRESS = new LiteFlowElementType("LITEFLOW_LITE_FLOW_WHILE_SUB_EXPRESS");
  ...
  IElementType LITEFLOW_LAND = new LiteFlowTokenType("AND");
  ...
  IElementType LITEFLOW_LFOR = new LiteFlowTokenType("FOR");
  ...
  IElementType LITEFLOW_LNOT = new LiteFlowTokenType("NOT");
  ...
  IElementType LITEFLOW_NODE = new LiteFlowTokenType("node");
  ...
  IElementType LITEFLOW_UNODE = new LiteFlowTokenType("NODE");
  IElementType LITEFLOW_UTO = new LiteFlowTokenType("TO");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == LITEFLOW_LITE_FLOW_FOR_EXPRESS) {
        return new LiteFlowLiteFlowForExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_FOR_SUB_EXPRESS) {
        return new LiteFlowLiteFlowForSubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_ID_EXPRESS) {
        return new LiteFlowLiteFlowIdExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_2_ELIF_EXPRESS) {
        return new LiteFlowLiteFlowIf2ElifExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_2_ELIF_SUB_EXPRESS) {
        return new LiteFlowLiteFlowIf2ElifSubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_2_ELSE_EXPRESS) {
        return new LiteFlowLiteFlowIf2ElseExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_2_ELSE_SUB_EXPRESS) {
        return new LiteFlowLiteFlowIf2ElseSubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_2_EXPRESS) {
        return new LiteFlowLiteFlowIf2ExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_2_SUB_EXPRESS) {
        return new LiteFlowLiteFlowIf2SubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_3_EXPRESS) {
        return new LiteFlowLiteFlowIf3ExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_IF_3_SUB_EXPRESS) {
        return new LiteFlowLiteFlowIf3SubExpressImpl(node);
      }
      ...
      else if (type == LITEFLOW_LITE_FLOW_NODE_REF_SUB_EXPRESS) {
        return new LiteFlowLiteFlowNodeRefSubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_NODE_STRING_REF) {
        return new LiteFlowLiteFlowNodeStringRefImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_NODE_STRING_SUB_EXPRESS) {
        return new LiteFlowLiteFlowNodeStringSubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_NOT_EXPRESS) {
        return new LiteFlowLiteFlowNotExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_OR_EXPRESS) {
        return new LiteFlowLiteFlowOrExpressImpl(node);
      }
      ...
      else if (type == LITEFLOW_LITE_FLOW_SWITCH_SUB_EXPRESS) {
        return new LiteFlowLiteFlowSwitchSubExpressImpl(node);
      }
      ...
      else if (type == LITEFLOW_LITE_FLOW_THEN_SUB_EXPRESS) {
        return new LiteFlowLiteFlowThenSubExpressImpl(node);
      }
      ...
      else if (type == LITEFLOW_LITE_FLOW_WHEN_SUB_EXPRESS) {
        return new LiteFlowLiteFlowWhenSubExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_WHILE_EXPRESS) {
        return new LiteFlowLiteFlowWhileExpressImpl(node);
      }
      else if (type == LITEFLOW_LITE_FLOW_WHILE_SUB_EXPRESS) {
        return new LiteFlowLiteFlowWhileSubExpressImpl(node);
      }
