...
public class LiteFlowLiteFlowForSubExpressImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowForSubExpress {

  public LiteFlowLiteFlowForSubExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowForSubExpress(this);
  }
