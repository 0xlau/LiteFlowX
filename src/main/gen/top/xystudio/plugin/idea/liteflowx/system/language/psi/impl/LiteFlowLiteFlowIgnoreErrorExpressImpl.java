...
public class LiteFlowLiteFlowIgnoreErrorExpressImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowIgnoreErrorExpress {

  public LiteFlowLiteFlowIgnoreErrorExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowIgnoreErrorExpress(this);
  }
