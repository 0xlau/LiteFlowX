...
public class LiteFlowOpSelfStatementImpl extends ASTWrapperPsiElement implements LiteFlowOpSelfStatement {

  public LiteFlowOpSelfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitOpSelfStatement(this);
  }
  ...
  public LiteFlowOpSelfExpress getOpSelfExpress() {
    return findNotNullChildByClass(LiteFlowOpSelfExpress.class);
  }
