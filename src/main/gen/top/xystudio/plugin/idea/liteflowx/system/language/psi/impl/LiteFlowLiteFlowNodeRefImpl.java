...
public class LiteFlowLiteFlowNodeRefImpl extends ASTWrapperPsiElement implements LiteFlowLiteFlowNodeRef {

  public LiteFlowLiteFlowNodeRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitLiteFlowNodeRef(this);
  }
  ...
  public PsiElement getIdentifier() {
    return findNotNullChildByType(LITEFLOW_IDENTIFIER);
  }
