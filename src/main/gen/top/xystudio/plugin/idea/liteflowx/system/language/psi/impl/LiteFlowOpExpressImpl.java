...
public class LiteFlowOpExpressImpl extends ASTWrapperPsiElement implements LiteFlowOpExpress {

  public LiteFlowOpExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitOpExpress(this);
  }
  ...
  @Override
  @Nullable
  public LiteFlowValue getValue() {
    return findChildByClass(LiteFlowValue.class);
  }
