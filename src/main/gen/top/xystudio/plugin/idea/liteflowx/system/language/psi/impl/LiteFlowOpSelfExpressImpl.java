...
public class LiteFlowOpSelfExpressImpl extends ASTWrapperPsiElement implements LiteFlowOpSelfExpress {

  public LiteFlowOpSelfExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitOpSelfExpress(this);
  }
