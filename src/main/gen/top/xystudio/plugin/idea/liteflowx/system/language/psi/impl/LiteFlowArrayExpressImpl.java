...
public class LiteFlowArrayExpressImpl extends ASTWrapperPsiElement implements LiteFlowArrayExpress {

  public LiteFlowArrayExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitArrayExpress(this);
  }
