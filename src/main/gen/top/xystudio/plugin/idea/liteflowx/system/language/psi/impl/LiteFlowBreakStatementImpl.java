...
public class LiteFlowBreakStatementImpl extends ASTWrapperPsiElement implements LiteFlowBreakStatement {

  public LiteFlowBreakStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
