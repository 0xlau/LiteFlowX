...
public class LiteFlowUseArrayExpressImpl extends ASTWrapperPsiElement implements LiteFlowUseArrayExpress {

  public LiteFlowUseArrayExpressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitUseArrayExpress(this);
  }
