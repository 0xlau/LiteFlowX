...
public class LiteFlowAllExpressStatementImpl extends ASTWrapperPsiElement implements LiteFlowAllExpressStatement {

  public LiteFlowAllExpressStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LiteFlowVisitor visitor) {
    visitor.visitAllExpressStatement(this);
  }
